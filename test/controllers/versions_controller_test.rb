...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { belongs_to: @version.belongs_to, name: @version.name } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { belongs_to: @version.belongs_to, name: @version.name } }
